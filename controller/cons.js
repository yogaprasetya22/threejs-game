...
class FirstPersonCameraDemo {
    ...
    initializeDemo_() {
        ...
        this.controls_.noFly = true;
        this.controls_.lookVertical = true;
        this.controls_.constrainVertical = true;
        this.controls_.locked = true;

        this.fpsCamera_ = new FirstPersonCamera(this.camera_, this.objects_);
        // this.fpsCamera_.lock();
    }
    ...
    loadMaterial_(name, tiling) {
        ...
        const albedo = mapLoader.load(
            "resources/freepbr/" + name + "albedo.png"
        );
